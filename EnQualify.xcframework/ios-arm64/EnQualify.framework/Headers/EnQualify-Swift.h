...
SWIFT_PROTOCOL("_TtP9EnQualify15CaptureDelegate_")
@protocol CaptureDelegate
- (void)captureStart;
- (void)frontCaptureCompletedWithImage:(NSData * _Nullable)image;
- (void)frontCaptureRetried;
- (void)backCaptureCompletedWithImage:(NSData * _Nullable)image;
- (void)backCaptureRetried;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nullable referenceId;)
+ (NSString * _Nullable)referenceId SWIFT_WARN_UNUSED_RESULT;
+ (void)setReferenceId:(NSString * _Nullable)value;
...
+ (void)nfcStore;
+ (void)setFaceCaptureWithEnable:(BOOL)enable;
...
SWIFT_CLASS("_TtC9EnQualify22EnVerifyCaptureManager")
@interface EnVerifyCaptureManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, copy) NSString * _Nullable callTypeValue;
@property (nonatomic, copy) NSString * _Nullable identityType;
@property (nonatomic, copy) NSString * _Nullable identityNo;
@property (nonatomic, copy) NSString * _Nullable name;
@property (nonatomic, copy) NSString * _Nullable surname;
...
SWIFT_CLASS("_TtC9EnQualify13KYBController")
@interface KYBController : UIViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UINavigationController * _Nullable navC;)
+ (UINavigationController * _Nullable)navC SWIFT_WARN_UNUSED_RESULT;
+ (void)setNavC:(UINavigationController * _Nullable)value;
...
SWIFT_CLASS("_TtC9EnQualify10KYBManager")
@interface KYBManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UINavigationController * _Nullable navC;)
+ (UINavigationController * _Nullable)navC SWIFT_WARN_UNUSED_RESULT;
+ (void)setNavC:(UINavigationController * _Nullable)value;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
