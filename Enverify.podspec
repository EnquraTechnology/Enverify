   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.1.38.7.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.1.38.7/EnVerify.framework" , "EnVerify-1.1.38.7/IDVerify.framework"
