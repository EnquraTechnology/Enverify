  Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.0.44.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.0.44/EnVerify.xcframework"
