   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/0.0.0.29.zip"}
    spec.ios.vendored_frameworks = "EnVerify-0.0.0.29/EnQualify.xcframework" , "EnVerify-0.0.0.29/IDVerification.xcframework"
    spec.ios.frameworks = "EnQualify"
    spec.requires_arc = true	
    spec.swift_versions = '5.0'
    spec.xcconfig = { 'OTHER_LDFLAGS' => '-lc++ -lsqlite3 -lz -framework AVFoundation -framework Accelerate -framework CFNetwork -framework CoreGraphics -framework CoreImage -framework CoreMedia -framework CoreTelephony -framework CoreVideo -framework FBLPromises -framework Foundation -framework LocalAuthentication -framework Security -framework SocketIO -framework SystemConfiguration -framework TensorFlowLite -framework UIKit' ,'OTHER_LDFLAGS[sdk=iphonesimulator*]' => '-Wl,-undefined,dynamic_lookup'}
    spec.pod_target_xcconfig = { 'VALID_ARCHS' => 'arm64' ,  'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => '' , 'IPHONEOS_DEPLOYMENT_TARGET' => '11.0' , 'OTHER_LDFLAGS' => '-lc++ -lsqlite3 -lz -framework AVFoundation -framework Accelerate -framework CFNetwork -framework CoreGraphics -framework CoreImage -framework CoreMedia -framework CoreTelephony -framework CoreVideo -framework FBLPromises -framework Foundation -framework LocalAuthentication -framework Security -framework SocketIO -framework SystemConfiguration -framework TensorFlowLite -framework UIKit','OTHER_LDFLAGS[sdk=iphonesimulator*]' => '-Wl,-undefined,dynamic_lookup'}
    spec.user_target_xcconfig = { 'VALID_ARCHS' => 'arm64' , 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => '' , 'IPHONEOS_DEPLOYMENT_TARGET' => '11.0' ,'ONLY_ACTIVE_ARCH' => 'YES', 'OTHER_LDFLAGS' => '-lc++ -lsqlite3 -lz -framework AVFoundation -framework Accelerate -framework CFNetwork -framework CoreGraphics -framework CoreImage -framework CoreMedia -framework CoreTelephony -framework CoreVideo -framework FBLPromises -framework Foundation -framework LocalAuthentication -framework Security -framework SocketIO -framework SystemConfiguration -framework TensorFlowLite -framework UIKit','OTHER_LDFLAGS[sdk=iphonesimulator*]' => '-Wl,-undefined,dynamic_lookup'}
