   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.1.991.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.1.991/EnQualify.xcframework" , "EnVerify-1.1.991/IDVerification.xcframework"
