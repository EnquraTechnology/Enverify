Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.3.14.5.zip"}
    spec.vendored_frameworks = "EnVerify-1.3.14.5/EnQualify.xcframework" , "EnVerify-1.3.14.5/IDVerification.xcframework"
