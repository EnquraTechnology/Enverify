  Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.0.46.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.0.46/EnVerify.framework" , "EnVerify-1.0.46/IDVerify.framework"
