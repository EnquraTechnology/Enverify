   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/0.0.0.19.zip"}
    spec.ios.vendored_frameworks = "EnVerify-0.0.0.19/EnQualify.xcframework" , "EnVerify-0.0.0.19/IDVerification.xcframework"
    ...
    spec.user_target_xcconfig = { 'VALID_ARCHS' => 'arm64' , 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'x86_64' , 'IPHONEOS_DEPLOYMENT_TARGET' => '11.0' ,'ONLY_ACTIVE_ARCH' => 'YES'}
