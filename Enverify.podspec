   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.1.39.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.1.39/EnVerify.xcframework" , "EnVerify-1.1.39/IDVerify.xcframework"
