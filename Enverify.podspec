   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/0.0.0.21.zip"}
    spec.ios.vendored_frameworks = "EnVerify-0.0.0.21/EnQualify.xcframework" , "EnVerify-0.0.0.21/IDVerification.xcframework"
