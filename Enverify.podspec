   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/0.0.0.35.zip"}
    spec.vendored_frameworks = "EnVerify-0.0.0.35/EnQualify.xcframework" , "EnVerify-0.0.0.35/IDVerification.xcframework"
    spec.ios.frameworks = "EnQualify"
    spec.requires_arc = true	
    spec.swift_versions = '5.0'
 
    spec.pod_target_xcconfig = { 'VALID_ARCHS' => 'arm64' ,  'EXCLUDED_ARCHS[sdk=iphonesimulator*][arch*]' => 'arm64' ,'EXCLUDED_ARCHS[sdk=iphoneos*][arch*]' => '', 'IPHONEOS_DEPLOYMENT_TARGET' => '11.0' ,'ONLY_ACTIVE_ARCH' => 'YES'}
