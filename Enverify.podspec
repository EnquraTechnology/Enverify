  Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.00.13.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.00.13/EnVerify.framework" , "EnVerify-1.00.13/IDVerify.framework"
