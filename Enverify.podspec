   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.2.14.4.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.2.14.4/EnVerify.xcframework" , "EnVerify-1.2.14.4/IDVerify.xcframework"
