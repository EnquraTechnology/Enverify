   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.3.18.5.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.3.18.5/EnQualify.xcframework" , "EnVerify-1.3.18.5/IDVerification.xcframework"
