   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.3.23.1-s.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.3.23.1-s/EnQualify.xcframework" , "EnVerify-1.3.23.1-s/IDVerification.xcframework"
