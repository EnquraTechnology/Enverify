   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.1.39.1.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.1.39.1/EnVerify.xcframework" , "EnVerify-1.1.39.1/IDVerify.xcframework"
