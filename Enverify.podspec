   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.1.35.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.1.35/EnVerify.framework" , "EnVerify-1.1.35/IDVerify.framework"
