   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/0.0.0.34.zip"}
    spec.vendored_frameworks = "EnVerify-0.0.0.34/EnQualify.xcframework" , "EnVerify-0.0.0.34/IDVerification.xcframework"
