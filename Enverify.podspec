  Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.0.48.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.0.48/EnVerify.framework" , "EnVerify-1.0.48/IDVerify.framework"
