   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/0.0.0.44.zip"}
    spec.vendored_frameworks = "EnVerify-0.0.0.44/EnQualify.xcframework" , "EnVerify-0.0.0.44/IDVerification.xcframework"
    spec.ios.frameworks = "EnQualify"
    spec.requires_arc = true	
    spec.swift_versions = '5.0'

spec.xcconfig = {
  'OTHER_LDFLAGS[sdk=iphonesimulator*]' => '-ObjC -lc++ -U MLKitBarcodeScanning -U MLImage  -U MLKitBarcodeScanning -U MLKitFaceDetection  -U MLKitCommon -U MLKitTextRecognition -U MLKitVision -U WebRTC',
