   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/0.0.0.45.zip"}
    spec.vendored_frameworks = "EnVerify-0.0.0.45/EnQualify.xcframework" , "EnVerify-0.0.0.45/IDVerification.xcframework"
    spec.ios.frameworks = "EnQualify"
    spec.requires_arc = true	
    spec.swift_versions = '5.0'

spec.xcconfig = {
  'OTHER_LDFLAGS[sdk=iphonesimulator*]' => '$(inherited) -ObjC -lc++',
