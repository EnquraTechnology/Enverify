   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.2.14.5.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.2.14.5/EnVerify.xcframework" , "EnVerify-1.2.14.5/IDVerify.xcframework"
