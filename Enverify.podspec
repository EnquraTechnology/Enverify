   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.2.13.4.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.2.13.4/EnVerify.framework" , "EnVerify-1.2.13.4/IDVerify.framework"
