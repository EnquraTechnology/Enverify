   Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/EnquraTechnology/Enverify/archive/refs/tags/1.2.14.3.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.2.14.3/EnQualify.xcframework" , "EnVerify-1.2.14.3/IDVerify.xcframework"
