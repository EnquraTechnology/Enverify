...
#ifndef IDVERIFY_SWIFT_H
#define IDVERIFY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IDVerify",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8IDVerify12CustomerChip")
...
- (BOOL)isChipAuthSucceeded SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isPassiveAuthSucceeded SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isActiveAuthSucceed SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC8IDVerify12CustomerFace")
...
SWIFT_CLASS("_TtC8IDVerify19CustomerIdentityDoc")
...
SWIFT_CLASS("_TtC8IDVerify8IDVerify")
...
SWIFT_PROTOCOL("_TtP8IDVerify16IDVerifyDelegate_")
...
SWIFT_CLASS("_TtC8IDVerify9NFCReader") SWIFT_AVAILABILITY(ios,introduced=13)
...
SWIFT_CLASS("_TtC8IDVerify8VSession")
