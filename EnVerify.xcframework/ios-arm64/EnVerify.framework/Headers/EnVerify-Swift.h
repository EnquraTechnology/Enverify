...
SWIFT_CLASS("_TtC8EnVerify5EnLog")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull releaseNumber;)
+ (NSString * _Nonnull)releaseNumber SWIFT_WARN_UNUSED_RESULT;
+ (void)setReleaseNumber:(NSString * _Nonnull)value;
...
+ (void)integrationAddWithType:(NSString * _Nonnull)type reference:(NSString * _Nonnull)reference callType:(NSString * _Nullable)callType phone:(NSString * _Nullable)phone email:(NSString * _Nullable)email data:(NSString * _Nonnull)data iDRegistration:(EnVerifyCallIDRegistrationModel * _Nullable)iDRegistration;
...
@interface EnVerify (SWIFT_EXTENSION(EnVerify))
+ (void)signDocumentWithData:(NSString * _Nonnull)data;
@end
...
- (id _Nullable)isPassiveAuthSucceed SWIFT_WARN_UNUSED_RESULT;
